...
img = cv2.imread(r"D:\FCI\The 3 Level\The Second Term\New\Digital Image Processing\imags\BonusTask\close.png", cv2.IMREAD_GRAYSCALE)

pad_size = B.shape[0] // 2
img_padded = cv2.copyMakeBorder(img, pad_size, pad_size, pad_size, pad_size, cv2.BORDER_CONSTANT, value=0)

for i in range(15): # Increase this value to increase Closing
...
img_closed = img_eroded[pad_size:-pad_size, pad_size:-pad_size]

# Display the images
cv2.imshow('Input Image', img)
cv2.imshow('Closed Image', img_closed)
cv2.waitKey(0)
