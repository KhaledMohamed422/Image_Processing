...
axs[0, 1].imshow(ideal_lowpass_filter(img, 5), cmap='gray')
axs[0, 1].set_title('D0 = 5')

axs[1, 0].imshow(ideal_lowpass_filter(img, 15), cmap='gray')
axs[1, 0].set_title('D0 = 15')

axs[1, 1].imshow(ideal_lowpass_filter(img, 30), cmap='gray')
axs[1, 1].set_title('D0 = 30')

fig.suptitle('Applying Ideal Lowpass Filter')
# display the plot
plt.show()
